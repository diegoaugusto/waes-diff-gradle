...
------------ | ------------- | -------------
Java | Oracle 1.8.0_131 | ([Not anymore](https://twitter.com/java/status/910944824353628160)) the latest version of Java.
...
As soon as all these tools are installed:
- Open Eclipse
...
- Go to the Gradle Executions tab and Run a build (it will download the dependencies, build and run all the unit tests)
