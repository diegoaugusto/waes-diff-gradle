...
public class DiffService extends AbstractService {
	 ...
	 */
	public Diff getDiff(Integer id) throws NotFoundException, BadRequestException {
	 ...
	 * @throws BadRequestException 
	 */
	private Diff getDiff(Integer id, DiffObject diffObject) throws NotFoundException, BadRequestException {
		if (diffObject == null) {
			throw new NotFoundException("Id does not exist.");
		}
		
		Diff diff = compare(diffObject.getLeft(), diffObject.getRight());
		diff.setId(id);
		return diff;
	}
	...
	/**
	 * This method compares two byte arrays and will return a {@link Diff} object containing information
	 * about this comparison:
	 *   - if they are equal
	 *   - if they have the same size
	 *   - the offset and lenghts of the differences
	 * 
	 * @param left
	 * @param right
	 ...
	 * @throws BadRequestException 
	 */
	public Diff compare(byte[] left, byte[] right) throws BadRequestException {
		if (left == null || right == null) {
			throw new BadRequestException("Binary data is null.");
		}
